package com.lukegraham.addictiveadditions.util;
...
public enum ModArmorMaterial implements IArmorMaterial {
    SLIME(AddictiveAdditions.MOD_ID + ":slime", 100, new int[]{1,2,2,1}, 5, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC,
            0.0F, () -> { return Ingredient.fromItems(Items.SLIME_BALL); });
